...
%numbers=left, 
%numberstyle= \tiny, 
%keywordstyle= \color{ blue!70},commentstyle=\color{red!50!green!50!blue!50},  commentstyle=\color{mygreen}\itshape,    % comment style
%morecomment=[l]{!\ },                    % Comment only with space after !
%frame=shadowbox, 
...
%\begin{tcolorbox}[colback=black!5!white,colframe=white]
%\begin{lstlisting}[frame=lrtb] [language=Fortran]
